...
import com.ddona.demorecycleview.databinding.ItemMusicOfflineBinding
import com.ddona.demorecycleview.model.MusicOffline

class MusicOfflineAdapter(val inter: IMusic) :
    RecyclerView.Adapter<MusicOfflineAdapter.MusicOfflineViewHolder>() {
    ...
    class MusicOfflineViewHolder(
        val binding: ItemMusicOfflineBinding,
        inter: IMusic
    ) :
